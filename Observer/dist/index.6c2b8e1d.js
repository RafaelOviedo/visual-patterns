...
})({"5PqtM":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "6d258e296c2b8e1d";
"use strict";
...
},{}],"78IPR":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.ConcreteObserverB = exports.ConcreteObserverA = exports.ConcretePublisher = void 0;
/**
* The Subject owns some important state and notifies observers when the state
* changes.
*/ var ConcretePublisher = /** @class */ function() {
    function ConcretePublisher(element) {
        this.observers = [];
        this.element = element;
    }
    /**
     * The subscription management methods.
     */ ConcretePublisher.prototype.subscribe = function(observer) {
        var observerExists = this.observers.includes(observer);
        if (observerExists) console.log('Subject: Observer has been subscribed already.');
        this.observers.push(observer);
        console.log("Subject: Subscribed observer: ".concat(observer.name));
    };
    ConcretePublisher.prototype.unsubscribe = function(observer) {
        var observerIndex = this.observers.indexOf(observer);
        if (observerIndex === -1) console.log('Subject: Nonexistent observer.');
        this.observers.splice(observerIndex, 1);
        console.log("Subject: Unsuscribed observer: ".concat(observer.name));
    };
    /**
    ...
    ConcretePublisher.prototype.someBusinessLogic = function() {
        console.log('\nSubject: I\'m doing something important.');
        this.state = Math.floor(Math.random() * 11);
        this.element.innerHTML = this.state.toString();
...
*/ var ConcreteObserverA = /** @class */ function() {
    function ConcreteObserverA(element) {
        this.name = 'Observer A';
        this.element = element;
    }
    ConcreteObserverA.prototype.update = function(publisher) {
...
var ConcreteObserverB = /** @class */ function() {
    function ConcreteObserverB(element) {
        this.name = 'Observer B';
        this.element = element;
    }
    ConcreteObserverB.prototype.update = function(publisher) {
...
},{}]},["5PqtM","78IPR"], "78IPR", "parcelRequire94c2")

//# sourceMappingURL=index.6c2b8e1d.js.map
